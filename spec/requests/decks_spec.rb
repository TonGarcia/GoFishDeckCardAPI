...
RSpec.describe "/decks", type: :request do
  ...
  # DecksController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get decks_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Deck" do
        expect {
          post decks_url,
               params: { deck: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Deck" do
        expect {
          post decks_url,
               params: { deck: invalid_attributes }, as: :json
        }.to change(Deck, :count).by(0)
      end

      it "renders a JSON response with errors for the new deck" do
        post decks_url,
             params: { deck: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested deck" do
      deck = Deck.create! valid_attributes
      expect {
        delete deck_url(deck), headers: valid_headers, as: :json
      }.to change(Deck, :count).by(-1)
    end
  end
end
