...
ActiveRecord::Schema.define(version: 2020_11_13_221636) do
  ...
  create_table "cards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["suit_rank"], name: "index_cards_on_suit_rank"
  end
  ...
  create_table "games_players", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "game_id", null: false
    t.bigint "player_id", null: false
